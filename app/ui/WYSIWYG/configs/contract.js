...
import {Superscript, Subscript} from '../marks/XScript'
import { AutoLinkPlugin } from '../plugins/Autolink'
import {FileUploadNode} from '../nodes/FileUpload'
import {ContractLinkPreview} from '../nodes/ContractLink'
import { FontSize } from '../marks/FontSize'

export default function createContractEditorConfig(placeholder, content) {
    return {
        extensions: [
          Document,
          Paragraph.configure({
