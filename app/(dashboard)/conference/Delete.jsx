...
export default function Delete({control, data}){
    ...
    <div className="bg-white w-[80%] md:w-1/2 lg:w-1/3 2xl:w-[20%] py-1 px-4 rounded-lg">
        <div className="flex flex-col items-center justify-center gap-y-4 my-4">
            ...
            <span className="text-warning font-bold">Delete Training</span>
        </div>
        <p className="my-8 text-center text-sm">
        Are you sure? This action cannot be undone. All values associated with this training will be lost.
        </p>
        <div className="flex w-full justify-between gap-4 my-4 text-xs md:text-sm">
            <button className="py-2 px-4 w-[50%] whitespace-nowrap rounded-md font-semibold bg-warning text-white" onClick={e=>submit(e)}>Yes, Delete Training</button>
